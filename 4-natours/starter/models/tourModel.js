...
const tourSchema = new mongoose.Schema(
  {
    ...
    ratingsAverage: {
      ...
      set: val => Math.round(val * 10) / 10 // This operation is because this .round returns an integer
    },
    ratingsQuantity: {
      type: Number,
      default: 0
...
tourSchema.index({ startLocation: '2dsphere' }); // The option '2dsphere' is to index geospatial data
